...
test("ships local project storage, packaging, and multi-file chat operations", async () => {
  const [playground, store, packaging, runtime, bridge, packageJson] = await Promise.all([
